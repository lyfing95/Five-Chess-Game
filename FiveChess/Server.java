...
public class Server extends JFrame implements ActionListener{
	...
	public Server(){
		...
		button1.setBounds(new Rectangle(125,5,70,22));
		button1.setFont(new Font("宋体",0,14));
		
		label2.setBounds(new Rectangle(195,5,70,22));
		label2.setFont(new Font("宋体",0,14));
		
		text2.setBounds(new Rectangle(265,5,100,22));
		text2.setText("请输入信息");
		
		button2.setBounds(new Rectangle(365,5,70,22));
		button2.setFont(new Font("宋体",0,14));
		
		button3.setBounds(new Rectangle(440,5,70,22));
		button3.setFont(new Font("宋体",0,14));
		
		
		jscrollpane.setBounds(new Rectangle(5,30,520,130));
		...
		panel1.setBounds(new Rectangle(0,0,600,240));
		contenpane.add(panel1);
		
		panel2=new QipanPane();
		panel2.setBounds(10, 200, 500, 500);
	...
	class QipanPane extends JPanel{
		...
		protected void paintComponent(Graphics g){
			...
			//绘制棋盘
			for(int i=0;i<19;i++){
				g1.drawLine(70, 70+20*i, 70+18*20, 70+20*i);
				g1.drawLine(70+20*i, 70, 70+20*i, 70+18*20);
			}
			//绘制准星
			g1.fillOval(128, 128, 6, 6);
			g1.fillOval(248, 128, 6, 6);
			g1.fillOval(368, 128, 6, 6);
			g1.fillOval(248, 248, 6, 6);
			g1.fillOval(248, 368, 6, 6);
			g1.fillOval(128, 248, 6, 6);
			g1.fillOval(128, 368, 6, 6);
			g1.fillOval(368, 248, 6, 6);
			g1.fillOval(368, 368, 6, 6);
			//绘制全部棋子
			for(int i=0;i<19;i++)
				for(int j=0;j<19;j++){
					if(allChess[i][j]==1){
